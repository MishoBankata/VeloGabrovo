...
Повече информация относно проекта в нашата страница: https://mishobankata.github.io/VeloGabrovo


1. Проектът „ВелоГаброво“ цели да създаде мрежа от велоалеи в територията на град Габрово, която да направи придвижването с колело в рамките на града удобно и безопасно. С това искаме да допринесем за подобряването на градската среда и да осигурим на габровци алтернативен начин на транспорт, който е по-здравословен и по-добър за околната среда. Ние сме наясно с факта, че наред със своите предимства, колоезденето крие и някои недостатъци. Изграждайки мрежа от велоалеи, целим да сведем до минимум тези рискове. Например опасността от инциденти ще бъде значително по-малка, защото маршрутите за колоездене ще бъдат колкото се може по-отделени от трафика на коли.

2. Съществуващите велоалеи на територията на Габрово са крайно недостатъчни за жителите на града.
В момента има само 2 велоалеи, разположени от двете страни на река Янтра, които са твърде къси или твърде тесни за да бъдат използвани от колоездачите в Габрово. Това, от своя страна, води до избягването на велоалеите от множество велосипедисти.
...
Други недостатъци на леките автомобили са сравнително високата цена за пътна инфраструктура и пространството, нужно за автомобили (пътища и паркоместа).
Така в много от случаите велосипедът е по-ефективен от лекия автомобил в градска среда.
Осъществяването на този проект ще доведе до увеличаване на безопасността по пътищата, предоставяне на алтернативно транспортно средство за жителите на Габрово, намаляване на емисиите на парникови газове и подобряване на градската среда.
...
Главните ни цели са две – изграждане на велоалеите, посочени в плана, и насърчаване на габровците да ползват велосипеди за придвижване в града.
...
Велоалеята продължава по продължението на ул. Юрий Венелин до едноименния площад.
...
От кръстовището с ул. Ген. Николов, ул. Александър Стамболийски и ул. Антим I-ви се разклонява велоалея, която достига Северната промишлена зона.
...
Велоалеята продължава успоредно на ул. Орловска и река Янтра, а после само покрай реката, където липсва всякакви пътища или други препятствия.
...
Маршрутът свързва също и южната промишлена зона и парк Маркотея.
Два изоставени обекта са в непосредствена близост - бившият градски басейн и колодрум на Габрово.
...
В околността са и ТУ Габрово и МБАЛ "д-р Тота Венкова".
Маршрутът е най-подходящ за отдих.

    ---
Всички маршрути могат да се видят графично в уебсайта на проекта (https://mishobankata.github.io/VeloGabrovo/map.html).
...
Всеки маршрут ще се изгражда за период от 1 месец.
...
За създаването на по-голямата част от маршрутите са необходими само боя за обозначаване на велоалеите и колчета за физическото им отделяне от пътните платна.
Разходът на червена боя за един квадратен метър е между 300 и 500 мл.
Цената за един литър е между 7,5 и 10 лв. за литър.
Цената за колчетата варира значително според вида им и разстоянието, през което се поставят.
Допълнителни ресурси са нужни за участъците, налагащи подмяна на пътната настилка или тротоара.
Планираният бюджет за изграждане на маршрутите е между 730 хил. и 1,93 млн. лева.
Системата за колела под наем се очаква да струва около 500 хил. лева.
